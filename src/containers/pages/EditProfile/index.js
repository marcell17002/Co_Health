        ...
        return (
            <View style={{flex:1,marginHorizontal:15}}>
                <View style={{alignSelf:'center',marginTop:'5%'}}>
                    <Image style={{width:100,height:100,borderRadius:100/2}}source={require('../../../assets/profile.jpg')}/>
                </View>
                <View>
                ...
                <View style={{backgroundColor:'#6B8BFF',paddingHorizontal:12,paddingVertical:11,borderRadius:15,marginTop:15,alignSelf:'flex-end'}}>
