    ...
    render(){
        ...
        return (
            ...
            <View style={{flex:1,backgroundColor:'white'}}>
                <View>
                    <Image style={{width:300,height:220,marginTop:20, marginLeft: 50}} source={require('../../../assets/register.png')} />
                    <Text style={{fontSize:20, textAlign:"center",marginTop:20,marginBottom:20}}>Know more about you!</Text>
                </View>
            ...
            <View style={{height:40,backgroundColor:'#ededed'}}>
                ...
                <Text style={{fontSize:12, color:'grey'}}>made with love !</Text>
                </View>
            </View>
            </View>
        )
